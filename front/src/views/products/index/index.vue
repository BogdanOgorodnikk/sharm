<template>
  <OurPage width="wide" wide-page :title="$t('title.products')">
    ...
    <div class="product-header">
      <OurButton
        v-if="isAdmin"
        class="product-header-button"
        :text="$t('button.createProduct')"
        size="sm"
        @click="onClickOpenCreateProductPage"
      >
        <template #icon-left>
          <OurSvgIcon name="Plus2" color="white" />
        </template>
      </OurButton>

      <OurButton
        v-if="user.priceId || isAdmin"
        class="product-header-button"
        :text="isAdmin ? $t('button.createInvoice') : $t('button.createOrder')"
        size="sm"
        @click="onClickOpenOrdersAddPage"
      >
        <template #icon-left>
          <OurSvgIcon name="Clipboard-list" color="white" />
        </template>
      </OurButton>
...
export default {
  ...
  methods: {
    ...
    onClickOpenOrdersAddPage() {
      this.$router.push({ name: "ProductOrdersAdd" });
    },

    onClickOpenCreateProductPage() {
      this.$router.push({ name: "ProductsAdd" });
    },
  },
};
</script>
...
.product {
  ...
  &-header {
    @apply lg:flex;
    @apply mb-6 space-y-4 lg:space-x-4 lg:space-y-0;
