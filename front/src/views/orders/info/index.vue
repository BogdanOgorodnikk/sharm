...
export default {
  ...
  methods: {
    ...
    onClickEditOrderProduct(item) {
      this.$router.push({ name: "OrdersEditProduct", params: { id: item.id } });
    },

    onClickAddProductToOrder() {
      this.$router.push({ name: "OrdersAddProduct", params: { orderId: this.$route.params.id } });
    },
