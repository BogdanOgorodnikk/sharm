...
import OrderForm from "@/views/orders/_components/OrderForm";
  ...
  methods: {
    async onSubmitForm() {
      ...
      if (this.form.isValid) {
        ...
        await this.$router.push({ name: "OrdersInfo", params: { id: this.$route.params.orderId } });
      }
    },

    onClickBackToOrder() {
      this.$router.push({ name: "OrdersInfo", params: { id: this.$route.params.orderId } });
    },
  },
};
</script>
